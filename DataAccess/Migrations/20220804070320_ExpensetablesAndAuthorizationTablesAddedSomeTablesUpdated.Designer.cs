...
namespace DataAccess.Migrations
{
    ...
    [Migration("20220804070320_ExpensetablesAndAuthorizationTablesAddedSomeTablesUpdated")]
    partial class ExpensetablesAndAuthorizationTablesAddedSomeTablesUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Abstract.sp_GetAuthorization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AuthorizationDefinitionId")
                        .HasColumnType("int");

                    b.Property<string>("AuthorizationTypeDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("AuthorizationTypeId")
                        .HasColumnType("int");

                    b.Property<string>("AuthorizationTypeName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("SpecialAuthorization1")
                        .HasColumnType("bit");

                    b.Property<string>("SpecialAuthorization1Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("SpecialAuthorization2")
                        .HasColumnType("bit");

                    b.Property<string>("SpecialAuthorization2Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("SpecialAuthorization3")
                        .HasColumnType("bit");

                    b.Property<string>("SpecialAuthorization3Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("SpecialAuthorization4")
                        .HasColumnType("bit");

                    b.Property<string>("SpecialAuthorization4Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("SpecialAuthorization5")
                        .HasColumnType("bit");

                    b.Property<string>("SpecialAuthorization5Description")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Sp_GetAuthorizations");
                });

            modelBuilder.Entity("Core.Entities.Concrete.Authorization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.AuthorizationDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AuthorizationDefinitions");
                });

            modelBuilder.Entity("Core.Entities.Concrete.AuthorizationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entities.Concrete.Expense", b =>
                {
                    ...
                    b.Property<int>("PersonelDefinitionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PersonelDefinitionId");
            ...
            modelBuilder.Entity("Entities.Concrete.ExpenseDefinition", b =>
                {
                    ...
                    b.Property<bool>("IsPersonelCanBeSelected")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPersonelSelectionRequired")
                        .HasColumnType("bit");

                    b.Property<bool>("IsVehicleCanBeSelected")
                        .HasColumnType("bit");

                    b.Property<bool>("IsVehicleSelectionRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Entities.Concrete.PersonelDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Authorization", b =>
                {
                    b.HasOne("Core.Entities.Concrete.AuthorizationType", "AuthorizationType")
            ...
            modelBuilder.Entity("Entities.Concrete.Expense", b =>
                {
                    ...
                    b.HasOne("Entities.Concrete.PersonelDefinition", "PersonelDefinition")
                        .WithMany("Expenses")
                        .HasForeignKey("PersonelDefinitionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("PersonelDefinition");
                });

            modelBuilder.Entity("Entities.Concrete.PersonelDefinition", b =>
                {
                    b.HasOne("Entities.Concrete.Office", "Office")
                        .WithMany("PersonelDefinitions")
                        .HasForeignKey("OfficeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.Concrete.Office", b =>
                {
                    ...
                    b.Navigation("PersonelDefinitions");
                });

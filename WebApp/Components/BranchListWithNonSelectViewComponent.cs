...
{
    public class BranchListWithNonSelectViewComponent : ViewComponent
    {
        private IBranchService _branchService;

        public BranchListWithNonSelectViewComponent(IBranchService branchService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int branchId)
        {
            ...
            return View("BranchListWithNonSelect", mymodel);
        }
    }
}